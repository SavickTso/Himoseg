...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=5,
            help="skip rate of samples for test",
        )
        ...
        self.parser.add_argument(
            "--in_features", type=int, default=54, help="size of each model layer"
        )
        self.parser.add_argument(
            "--num_stage", type=int, default=12, help="size of each model layer"
        )
        self.parser.add_argument(
    ...
    def parse(self):
        ...
        if not self.opt.is_eval:
            ...
            log_name = "{}_in{}_out{}_ks{}_dctn{}".format(
                script_name,
                self.opt.input_n,
                self.opt.output_n,
